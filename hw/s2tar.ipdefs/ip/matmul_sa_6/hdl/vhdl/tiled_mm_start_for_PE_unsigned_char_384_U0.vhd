...
entity tiled_mm_start_for_PE_unsigned_char_384_U0 is 
    generic (
...
architecture rtl of tiled_mm_start_for_PE_unsigned_char_384_U0 is

    component tiled_mm_start_for_PE_unsigned_char_384_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_tiled_mm_start_for_PE_unsigned_char_384_U0_ShiftReg : tiled_mm_start_for_PE_unsigned_char_384_U0_ShiftReg
    generic map (
...
entity tiled_mm_start_for_PE_unsigned_char_384_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end tiled_mm_start_for_PE_unsigned_char_384_U0_ShiftReg;

architecture rtl of tiled_mm_start_for_PE_unsigned_char_384_U0_ShiftReg is
