...
entity tiled_mm_Block_newFuncRoot_proc_proc23 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of tiled_mm_Block_newFuncRoot_proc_proc23 is 
...
begin
    ...
    ap_return_assign_proc : process(ap_CS_fsm_state1, out_block_58, ap_block_state1, ap_return_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return <= out_block_58;
        else 
