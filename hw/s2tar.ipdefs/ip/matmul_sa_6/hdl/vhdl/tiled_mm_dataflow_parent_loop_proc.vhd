...
entity tiled_mm_dataflow_parent_loop_proc is
port (
...
architecture behav of tiled_mm_dataflow_parent_loop_proc is 
...
attribute shreg_extract : string;
    signal dataflow_in_loop_tm_loop_U0_h_fifo_0_0_read : STD_LOGIC;
    signal dataflow_in_loop_tm_loop_U0_v_fifo_0_0_read : STD_LOGIC;
    signal dataflow_in_loop_tm_loop_U0_v_fifo_0_1_read : STD_LOGIC;
    signal dataflow_in_loop_tm_loop_U0_v_fifo_0_2_read : STD_LOGIC;
    signal dataflow_in_loop_tm_loop_U0_v_fifo_0_3_read : STD_LOGIC;
    signal dataflow_in_loop_tm_loop_U0_v_fifo_0_4_read : STD_LOGIC;
    signal dataflow_in_loop_tm_loop_U0_v_fifo_0_5_read : STD_LOGIC;
    signal dataflow_in_loop_tm_loop_U0_h_fifo_1_0_read : STD_LOGIC;
    signal dataflow_in_loop_tm_loop_U0_h_fifo_2_0_read : STD_LOGIC;
    signal dataflow_in_loop_tm_loop_U0_h_fifo_3_0_read : STD_LOGIC;
    signal dataflow_in_loop_tm_loop_U0_h_fifo_4_0_read : STD_LOGIC;
    signal dataflow_in_loop_tm_loop_U0_h_fifo_5_0_read : STD_LOGIC;
    signal dataflow_in_loop_tm_loop_U0_Cstream_din : STD_LOGIC_VECTOR (7 downto 0);
    signal dataflow_in_loop_tm_loop_U0_Cstream_write : STD_LOGIC;
    signal dataflow_in_loop_tm_loop_U0_ap_start : STD_LOGIC;
    signal dataflow_in_loop_tm_loop_U0_ap_done : STD_LOGIC;
    signal dataflow_in_loop_tm_loop_U0_ap_ready : STD_LOGIC;
    signal dataflow_in_loop_tm_loop_U0_ap_idle : STD_LOGIC;
    signal dataflow_in_loop_tm_loop_U0_ap_continue : STD_LOGIC;
    ...
    component tiled_mm_dataflow_in_loop_tm_loop IS
    port (
...
begin
    dataflow_in_loop_tm_loop_U0 : component tiled_mm_dataflow_in_loop_tm_loop
    port map (
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((not((loop_dataflow_input_count = bound_minus_1)) and (ap_start = ap_const_logic_1) and (dataflow_in_loop_tm_loop_U0_ap_ready = ap_const_logic_1))) then 
                    loop_dataflow_input_count <= std_logic_vector(unsigned(loop_dataflow_input_count) + unsigned(ap_const_lv5_1));
                elsif (((ap_start = ap_const_logic_1) and (dataflow_in_loop_tm_loop_U0_ap_ready = ap_const_logic_1) and (loop_dataflow_input_count = bound_minus_1))) then 
                    loop_dataflow_input_count <= ap_const_lv5_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((not((loop_dataflow_output_count = bound_minus_1)) and (dataflow_in_loop_tm_loop_U0_ap_continue = ap_const_logic_1) and (dataflow_in_loop_tm_loop_U0_ap_done = ap_const_logic_1))) then 
                    loop_dataflow_output_count <= std_logic_vector(unsigned(loop_dataflow_output_count) + unsigned(ap_const_lv5_1));
                elsif (((dataflow_in_loop_tm_loop_U0_ap_continue = ap_const_logic_1) and (dataflow_in_loop_tm_loop_U0_ap_done = ap_const_logic_1) and (loop_dataflow_output_count = bound_minus_1))) then 
                    loop_dataflow_output_count <= ap_const_lv5_0;
                end if; 
            end if;
        end if;
    ...
    ap_done_assign_proc : process(dataflow_in_loop_tm_loop_U0_ap_done, loop_dataflow_output_count, bound_minus_1)
    begin
        if (((dataflow_in_loop_tm_loop_U0_ap_done = ap_const_logic_1) and (loop_dataflow_output_count = bound_minus_1))) then 
    ...
    ap_idle_assign_proc : process(dataflow_in_loop_tm_loop_U0_ap_idle, ap_start, loop_dataflow_output_count)
    begin
        if (((ap_start = ap_const_logic_0) and (dataflow_in_loop_tm_loop_U0_ap_idle = ap_const_logic_1) and (loop_dataflow_output_count = ap_const_lv5_0))) then 
    ...
    ap_ready_assign_proc : process(dataflow_in_loop_tm_loop_U0_ap_ready, ap_start, loop_dataflow_input_count, bound_minus_1)
    begin
        if (((ap_start = ap_const_logic_1) and (dataflow_in_loop_tm_loop_U0_ap_ready = ap_const_logic_1) and (loop_dataflow_input_count = bound_minus_1))) then 
    ...
    dataflow_in_loop_tm_loop_U0_ap_continue_assign_proc : process(ap_continue, loop_dataflow_output_count, bound_minus_1)
    begin
        if ((not((loop_dataflow_output_count = bound_minus_1)) or (ap_continue = ap_const_logic_1))) then 
            dataflow_in_loop_tm_loop_U0_ap_continue <= ap_const_logic_1;
        else 
            dataflow_in_loop_tm_loop_U0_ap_continue <= ap_const_logic_0;
        end if; 
    end process;

    dataflow_in_loop_tm_loop_U0_ap_start <= ap_start;
    h_fifo_1_read <= dataflow_in_loop_tm_loop_U0_h_fifo_1_0_read;
    h_fifo_2_read <= dataflow_in_loop_tm_loop_U0_h_fifo_2_0_read;
    h_fifo_3_read <= dataflow_in_loop_tm_loop_U0_h_fifo_3_0_read;
    h_fifo_4_read <= dataflow_in_loop_tm_loop_U0_h_fifo_4_0_read;
    h_fifo_5_read <= dataflow_in_loop_tm_loop_U0_h_fifo_5_0_read;
    h_fifo_read <= dataflow_in_loop_tm_loop_U0_h_fifo_0_0_read;
    v_fifo_1_read <= dataflow_in_loop_tm_loop_U0_v_fifo_0_1_read;
    v_fifo_2_read <= dataflow_in_loop_tm_loop_U0_v_fifo_0_2_read;
    v_fifo_3_read <= dataflow_in_loop_tm_loop_U0_v_fifo_0_3_read;
    v_fifo_4_read <= dataflow_in_loop_tm_loop_U0_v_fifo_0_4_read;
    v_fifo_5_read <= dataflow_in_loop_tm_loop_U0_v_fifo_0_5_read;
    v_fifo_read <= dataflow_in_loop_tm_loop_U0_v_fifo_0_0_read;
end behav;
