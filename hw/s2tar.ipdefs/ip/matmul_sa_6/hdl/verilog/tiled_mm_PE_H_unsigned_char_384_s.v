...
module tiled_mm_PE_H_unsigned_char_384_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   ap_ready;
output  [7:0] return_r;
input  [15:0] h_fifo_5_4_dout;
input  [2:0] h_fifo_5_4_num_data_valid;
input  [2:0] h_fifo_5_4_fifo_cap;
input   h_fifo_5_4_empty_n;
output   h_fifo_5_4_read;
input  [15:0] v_fifo_5_4_dout;
input  [2:0] v_fifo_5_4_num_data_valid;
input  [2:0] v_fifo_5_4_fifo_cap;
input   v_fifo_5_4_empty_n;
output   v_fifo_5_4_read;
output  [15:0] h_fifo_5_5_din;
input  [2:0] h_fifo_5_5_num_data_valid;
input  [2:0] h_fifo_5_5_fifo_cap;
input   h_fifo_5_5_full_n;
output   h_fifo_5_5_write;
...
tiled_mm_mac_muladd_8s_8s_8ns_8_4_1 #(
    ...
    .din2_WIDTH( 8 ),
    .dout_WIDTH( 8 ))
mac_muladd_8s_8s_8ns_8_4_1_U292(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_166_p0),
    .din1(grp_fu_166_p1),
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        h_fifo_5_4_read = 1'b1;
    end else begin
        h_fifo_5_4_read = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        h_fifo_5_5_write = 1'b1;
    end else begin
        h_fifo_5_5_write = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v_fifo_5_4_read = 1'b1;
    end else begin
        v_fifo_5_4_read = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = ((h_fifo_5_5_full_n == 1'b0) | (v_fifo_5_4_empty_n == 1'b0) | (h_fifo_5_4_empty_n == 1'b0));
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

assign grp_fu_166_p0 = v_fifo_5_4_dout[7:0];

assign grp_fu_166_p1 = h_fifo_5_4_dout[7:0];

assign h_fifo_5_5_din = h_fifo_5_4_dout;

assign i_18_fu_104_p2 = (i_03_fu_54 + 9'd1);

assign icmp_ln33_fu_98_p2 = ((i_03_fu_54 == 9'd384) ? 1'b1 : 1'b0);

assign mul_ln41_fu_143_p0 = {{v_fifo_5_4_dout[15:8]}};

assign mul_ln41_fu_143_p1 = {{h_fifo_5_4_dout[15:8]}};

endmodule //tiled_mm_PE_H_unsigned_char_384_s
