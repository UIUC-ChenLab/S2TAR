...
module tiled_mm_PE_unsigned_char_384_4 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
output   start_write;
output  [7:0] return_r;
input  [15:0] h_fifo_0_3_dout;
input  [2:0] h_fifo_0_3_num_data_valid;
input  [2:0] h_fifo_0_3_fifo_cap;
input   h_fifo_0_3_empty_n;
output   h_fifo_0_3_read;
...
output  [15:0] h_fifo_0_4_din;
input  [2:0] h_fifo_0_4_num_data_valid;
input  [2:0] h_fifo_0_4_fifo_cap;
input   h_fifo_0_4_full_n;
output   h_fifo_0_4_write;
output  [15:0] v_fifo_1_3_din;
input  [2:0] v_fifo_1_3_num_data_valid;
input  [2:0] v_fifo_1_3_fifo_cap;
input   v_fifo_1_3_full_n;
output   v_fifo_1_3_write;
...
reg h_fifo_0_3_read;
reg v_fifo_0_3_read;
reg h_fifo_0_4_write;
reg v_fifo_1_3_write;
...
reg    h_fifo_0_3_blk_n;
wire    ap_CS_fsm_pp0_stage0;
reg    ap_enable_reg_pp0_iter1;
wire    ap_block_pp0_stage0;
reg    v_fifo_0_3_blk_n;
reg    h_fifo_0_4_blk_n;
...
tiled_mm_mac_muladd_8s_8s_8ns_8_4_1 #(
    ...
    .din2_WIDTH( 8 ),
    .dout_WIDTH( 8 ))
mac_muladd_8s_8s_8ns_8_4_1_U84(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_176_p0),
    .din1(grp_fu_176_p1),
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        h_fifo_0_3_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        h_fifo_0_3_read = 1'b1;
    end else begin
        h_fifo_0_3_read = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        h_fifo_0_4_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        h_fifo_0_4_write = 1'b1;
    end else begin
        h_fifo_0_4_write = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v_fifo_0_3_read = 1'b1;
    end else begin
        v_fifo_0_3_read = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        v_fifo_1_3_write = 1'b1;
    end else begin
        v_fifo_1_3_write = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = ((v_fifo_1_3_full_n == 1'b0) | (h_fifo_0_4_full_n == 1'b0) | (v_fifo_0_3_empty_n == 1'b0) | (h_fifo_0_3_empty_n == 1'b0));
end
...
assign grp_fu_176_p0 = v_fifo_0_3_dout[7:0];

assign grp_fu_176_p1 = h_fifo_0_3_dout[7:0];

assign h_fifo_0_4_din = h_fifo_0_3_dout;

assign i_23_fu_114_p2 = (i_03_fu_56 + 9'd1);

assign icmp_ln15_fu_108_p2 = ((i_03_fu_56 == 9'd384) ? 1'b1 : 1'b0);

assign mul_ln23_fu_153_p0 = {{v_fifo_0_3_dout[15:8]}};

assign mul_ln23_fu_153_p1 = {{h_fifo_0_3_dout[15:8]}};

assign start_out = real_start;

assign v_fifo_1_3_din = v_fifo_0_3_dout;

endmodule //tiled_mm_PE_unsigned_char_384_4
